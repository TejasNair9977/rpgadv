...
# keywords stores values that the user might type instead of the main commands. for example, if the user types
# supplies instead of buy, the program will know that the user wants to buy something, and wont cause any error
keywords = {"supplies": "buy",
            ...
            "mana": "mana",
            "health": "health",
            "increase-hp": "increase-hp",  # I added increase-hp to the keywords section
            "inn": "inn", # Also added inn to keywords section
            "inventory": "inv",
            "inv": "inv",
            "stats": "stats",
            "exit": "quit",
